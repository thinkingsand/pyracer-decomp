package object
{
   ...
   public class RGameEnt
   {
      ...
      public var currState:object.EntState;
      
      public var preState:object.EntState;
      ...
      public function RGameEnt(param1:ROBJECTINFO)
      {
         ...
         super();
         this.currState = new object.EntState();
         this.preState = new object.EntState();
      ...
      public function CollisionTest(param1:RGameEnt) : Boolean
      {
         ...
         if(_loc7_ = (_loc7_ = Math.max(Math.floor(_loc4_.length / _loc2_.m_radius),Math.floor(_loc5_.length / _loc3_.m_radius))) + 1)
         {
