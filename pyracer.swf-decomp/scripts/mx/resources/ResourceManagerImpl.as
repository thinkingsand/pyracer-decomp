package mx.resources
{
   ...
   public class ResourceManagerImpl extends EventDispatcher implements mx.resources.IResourceManager
   {
      ...
      private function processInfo(param1:Object) : void
      {
         ...
         ResourceBundle.mx_internal::locale = _loc2_ != null && _loc2_.length > 0 ? String(_loc2_[0]) : "en_US";
         var _loc3_:String = String(SystemManagerGlobals.parameters["localeChain"]);
