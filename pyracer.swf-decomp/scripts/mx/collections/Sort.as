package mx.collections
{
   ...
   public class Sort extends EventDispatcher
   {
      ...
      private function initSortFields(param1:Object, param2:Boolean = false) : Object
      {
         ...
         {
            SortField(this.fields[_loc4_]).mx_internal::initCompare(param1);
            _loc4_++;
         }
         if(param2)
         {
            ...
            while(_loc4_ < this.fields.length)
            {
               if((_loc6_ = (_loc5_ = this.fields[_loc4_]).mx_internal::getArraySortOnOptions()) == -1)
               {
                  return null;
               }
      ...
      private function internalCompare(param1:Object, param2:Object, param3:Array = null) : int
      {
         ...
         else
         {
            ...
            {
               _loc4_ = (_loc7_ = SortField(this._fields[_loc5_])).mx_internal::internalCompare(param1,param2);
               _loc5_++;
            }
         }
         return _loc4_;
      ...
      private function noFieldsCompare(param1:Object, param2:Object, param3:Array = null) : int
      {
         ...
         {
            this.defaultEmptyField = new mx.collections.SortField();
            try
            {
               this.defaultEmptyField.mx_internal::initCompare(a);
            }
            catch(e:SortError)
            {
