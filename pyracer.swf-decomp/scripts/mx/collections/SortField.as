package mx.collections
{
   ...
   public class SortField extends EventDispatcher
   {
      ...
      {
         if(this.mx_internal::usingCustomCompareFunction || this.name == null || this._compareFunction == this.xmlCompare || this._compareFunction == this.dateCompare)
         {
            return -1;
         }
         var _loc1_:* = 0;
      ...
      mx_internal function initCompare(param1:Object) : void
      {
         ...
         if(!this.mx_internal::usingCustomCompareFunction)
         {
      ...
      private function xmlCompare(param1:Object, param2:Object) : int
      {
         ...
         try
         {
            sa = this._name == null ? String(a.toString()) : String(a[this._name].toString());
         }
         catch(error:Error)
         {
         }
         try
         {
            sb = this._name == null ? String(b.toString()) : String(b[this._name].toString());
         }
         catch(error:Error)
         {
         }
