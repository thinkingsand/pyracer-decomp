   ...
   public class ChannelSet extends EventDispatcher
   {
      ...
      public function send(param1:MessageAgent, param2:IMessage) : void
      {
         ...
         if(connected)
         {
            if(!_hasRequestedClusterEndpoints && clustered)
            {
               ...
               _currentChannel.mx_internal::sendClusterRequest(new ClusterMessageResponder(_loc3_,this));
      ...
      public function channelConnectHandler(param1:ChannelEvent) : void
      {
         ...
         while(_pendingSends.length > 0)
         {
            ...
            if((_loc4_ = _loc3_.message as CommandMessage) != null && !_loc3_.agent.mx_internal::configRequested && _loc3_.agent.mx_internal::needsConfig && _loc4_.operation == CommandMessage.CLIENT_PING_OPERATION)
            {
      ...
      mx_internal function authenticationSuccess(param1:AuthenticationAgent, param2:AsyncToken, param3:AcknowledgeMessage) : void
      {
         ...
         _credentials = _loc6_;
         var _loc7_:int = int(_messageAgents.length);
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
