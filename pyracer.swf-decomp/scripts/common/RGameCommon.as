package common
{
   ...
   public class RGameCommon extends Sprite
   {
      ...
      public static var g_CommonData:common.RCommonData;
      
      public static var g_UserInfo:common.RUserInfo;
      ...
      public function Initialize() : void
      {
         ...
         g_CommonData = new common.RCommonData();
      ...
      public function InitUserInfo(param1:Object) : void
      {
         ...
         g_UserInfo = new common.RUserInfo();
         with(g_UserInfo)
         {
            uid = _uInfo.uid;
      ...
      private function getPersonalBestTime() : String
      {
         ...
         var _loc1_:int = int(g_UserInfo.maps[this.GameClient.m_TrackID - 1].personalbest);
      ...
      private function TranslateString(param1:String, param2:Boolean = false) : String
      {
         ...
         if(param1.search("%") >= 0)
         {
            ...
            {
               _loc3_ = String(_loc7_.firstname);
               if(param2)
               {
            ...
            {
               _loc3_ = String(_loc8_.firstname);
               if(param2)
               {
