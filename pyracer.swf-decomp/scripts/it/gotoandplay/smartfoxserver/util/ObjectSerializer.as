package it.gotoandplay.smartfoxserver.util
{
   public class ObjectSerializer
   {
      ...
      public static function getInstance(param1:Boolean = false) : it.gotoandplay.smartfoxserver.util.ObjectSerializer
      {
         if(instance == null)
         {
            instance = new it.gotoandplay.smartfoxserver.util.ObjectSerializer(param1);
         }
         return instance;
      }
      ...
      private function xml2obj(param1:XML, param2:Object) : void
      {
         ...
         {
            if((_loc5_ = String(_loc6_.name().toString())) == "obj")
            {
               _loc7_ = _loc6_.@o;
