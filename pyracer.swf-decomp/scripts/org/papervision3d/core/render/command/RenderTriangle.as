package org.papervision3d.core.render.command
{
   ...
   public class RenderTriangle extends RenderableListItem implements IRenderListItem
   {
      ...
      override public function hitTestPoint2D(param1:Point, param2:RenderHitData) : RenderHitData
      {
         ...
         if(Boolean(this.renderMat) && this.renderMat.interactive)
         {
      ...
      private function deepHitTest(param1:Triangle3D, param2:Vertex3DInstance, param3:RenderHitData) : RenderHitData
      {
         ...
         var _loc30_:Array;
         var _loc31_:Number = Number((_loc30_ = param1.uv)[0].u);
         ...
         {
            _loc40_ = BitmapMaterial.AUTO_MIP_MAPPING ? this.renderMat.widthOffset : _loc39_.width;
            _loc41_ = BitmapMaterial.AUTO_MIP_MAPPING ? this.renderMat.heightOffset : _loc39_.height;
         }
