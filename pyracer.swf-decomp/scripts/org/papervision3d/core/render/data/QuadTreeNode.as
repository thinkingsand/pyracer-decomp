package org.papervision3d.core.render.data
{
   ...
   public final class QuadTreeNode
   {
      ...
      public function QuadTreeNode(param1:Number, param2:Number, param3:Number, param4:Number, param5:int, param6:org.papervision3d.core.render.data.QuadTreeNode = null, param7:uint = 4)
      {
         super();
         this.level = param5;
         this.xdiv = param1;
