package org.papervision3d.core.render.data
{
   ...
   public final class QuadTree
   {
      ...
      private function getList(param1:org.papervision3d.core.render.data.QuadTreeNode) : void
      {
         if(!param1)
         {
            return;
      ...
      private function getParent(param1:org.papervision3d.core.render.data.QuadTreeNode = null) : void
      {
         if(!param1)
         {
            return;
