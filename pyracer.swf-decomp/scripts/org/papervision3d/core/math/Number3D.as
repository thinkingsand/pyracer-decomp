package org.papervision3d.core.math
{
   ...
   public class Number3D
   {
      ...
      private static var temp:org.papervision3d.core.math.Number3D = org.papervision3d.core.math.Number3D.ZERO;
      ...
      public static function add(param1:org.papervision3d.core.math.Number3D, param2:org.papervision3d.core.math.Number3D) : org.papervision3d.core.math.Number3D
      {
         return new org.papervision3d.core.math.Number3D(param1.x + param2.x,param1.y + param2.y,param1.z + param2.z);
      }
      
      public static function sub(param1:org.papervision3d.core.math.Number3D, param2:org.papervision3d.core.math.Number3D) : org.papervision3d.core.math.Number3D
      {
         return new org.papervision3d.core.math.Number3D(param1.x - param2.x,param1.y - param2.y,param1.z - param2.z);
      }
      
      public static function dot(param1:org.papervision3d.core.math.Number3D, param2:org.papervision3d.core.math.Number3D) : Number
      {
         return param1.x * param2.x + param1.y * param2.y + param2.z * param1.z;
      }
      
      public static function cross(param1:org.papervision3d.core.math.Number3D, param2:org.papervision3d.core.math.Number3D, param3:org.papervision3d.core.math.Number3D = null) : org.papervision3d.core.math.Number3D
      {
         if(!param3)
         {
            param3 = ZERO;
      ...
      {
         return new org.papervision3d.core.math.Number3D(0,0,0);
      }
      ...
      public function copyTo(param1:org.papervision3d.core.math.Number3D) : void
      {
         param1.x = this.x;
         param1.y = this.y;
         param1.z = this.z;
      ...
      public function copyFrom(param1:org.papervision3d.core.math.Number3D) : void
      {
         this.x = param1.x;
         this.y = param1.y;
         this.z = param1.z;
      ...
      public function plusEq(param1:org.papervision3d.core.math.Number3D) : void
      {
         this.x += param1.x;
         this.y += param1.y;
         this.z += param1.z;
      ...
      public function minusEq(param1:org.papervision3d.core.math.Number3D) : void
      {
         this.x -= param1.x;
         this.y -= param1.y;
         this.z -= param1.z;
