package org.papervision3d.core.proto
{
   ...
   public class DisplayObjectContainer3D extends EventDispatcher
   {
      ...
      public function addChild(param1:DisplayObject3D, param2:String = null) : DisplayObject3D
      {
         ...
         param2 = String(param2 || param1.name || String(param1.id));
      ...
      public function addChildren(param1:DisplayObject3D) : org.papervision3d.core.proto.DisplayObjectContainer3D
      {
      ...
      {
         if(Boolean(param1) && Boolean(this._children[param1]))
         {
