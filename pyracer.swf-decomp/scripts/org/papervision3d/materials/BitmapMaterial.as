package org.papervision3d.materials
{
   ...
   public class BitmapMaterial extends TriangleMaterial implements ITriangleDrawer
   {
      ...
      protected function correctBitmap(param1:BitmapData) : BitmapData
      {
         ...
         var _loc4_:Number = (_loc4_ = param1.width / _loc3_) == uint(_loc4_) ? _loc4_ : uint(_loc4_) + 1;
         var _loc5_:Number = (_loc5_ = param1.height / _loc3_) == uint(_loc5_) ? _loc5_ : uint(_loc5_) + 1;
