package org.papervision3d.objects
{
   ...
   public class DisplayObject3D extends DisplayObjectContainer3D
   {
      ...
      {
         return new org.papervision3d.objects.DisplayObject3D();
      }
      ...
      {
         var _loc2_:org.papervision3d.objects.DisplayObject3D = null;
         this._scene = param1;
      ...
      override public function addChild(param1:org.papervision3d.objects.DisplayObject3D, param2:String = null) : org.papervision3d.objects.DisplayObject3D
      {
      ...
      {
         var _loc3_:org.papervision3d.objects.DisplayObject3D = null;
         var _loc1_:String = this.name + "_" + this._numClones++;
         var _loc2_:org.papervision3d.objects.DisplayObject3D = new org.papervision3d.objects.DisplayObject3D(_loc1_);
         if(this.material)
         {
      ...
      public function distanceTo(param1:org.papervision3d.objects.DisplayObject3D) : Number
      {
      ...
      public function hitTestPoint(param1:Number, param2:Number, param3:Number) : Boolean
      {
         ...
         var _loc8_:Number;
         return (_loc8_ = !!this.geometry ? this.geometry.boundingSphere.maxDistance : 0) > _loc7_;
      }
      
      public function hitTestObject(param1:org.papervision3d.objects.DisplayObject3D, param2:Number = 1) : Boolean
      {
      ...
      public function setChildMaterial(param1:org.papervision3d.objects.DisplayObject3D, param2:MaterialObject3D, param3:MaterialObject3D = null) : void
      {
      ...
      private function updateMaterials(param1:org.papervision3d.objects.DisplayObject3D, param2:MaterialObject3D, param3:MaterialObject3D) : void
      {
         var _loc4_:org.papervision3d.objects.DisplayObject3D = null;
      ...
      public function project(param1:org.papervision3d.objects.DisplayObject3D, param2:RenderSessionData) : Number
      {
         var _loc5_:org.papervision3d.objects.DisplayObject3D = null;
      ...
      public function UpdateMatrix(param1:org.papervision3d.objects.DisplayObject3D, param2:RenderSessionData) : Number
      {
         var _loc5_:org.papervision3d.objects.DisplayObject3D = null;
         if(this._transformDirty)
         {
      ...
      public function lookAt(param1:org.papervision3d.objects.DisplayObject3D, param2:Number3D = null) : void
      {
         var _loc3_:org.papervision3d.objects.DisplayObject3D = null;
         ...
         {
            _loc3_ = this.parent as org.papervision3d.objects.DisplayObject3D;
            if(_loc3_)
            {
         ...
         {
            _loc3_ = param1.parent as org.papervision3d.objects.DisplayObject3D;
            if(_loc3_)
            {
      ...
      public function copyPosition(param1:*) : void
      {
         ...
         var _loc3_:Matrix3D = param1 is org.papervision3d.objects.DisplayObject3D ? param1.transform : param1;
      ...
      {
         var _loc4_:org.papervision3d.objects.DisplayObject3D = null;
         if(param1 is org.papervision3d.objects.DisplayObject3D)
         {
      ...
      public function addChildrenToLayer(param1:org.papervision3d.objects.DisplayObject3D, param2:ViewportLayer) : void
      {
         var _loc3_:org.papervision3d.objects.DisplayObject3D = null;
      ...
      protected function setParentContainer(param1:org.papervision3d.objects.DisplayObject3D, param2:Boolean = true) : void
      {
         var _loc3_:org.papervision3d.objects.DisplayObject3D = null;
