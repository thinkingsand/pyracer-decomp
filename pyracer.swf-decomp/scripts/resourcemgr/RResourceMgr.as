package resourcemgr
{
   ...
   public class RResourceMgr extends EventDispatcher
   {
      ...
      public var m_leveldata:resourcemgr.RResourceFile;
      ...
      public var m_Infofile:resourcemgr.RInfoFile;
      
      public function RResourceMgr()
      {
         super();
         this.m_leveldata = new resourcemgr.RResourceFile();
         this.m_Infofile = new resourcemgr.RInfoFile();
