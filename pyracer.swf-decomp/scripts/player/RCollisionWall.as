   ...
   public class RCollisionWall
   {
      ...
      public function InitCollisionWall() : void
      {
         ...
         while(_loc2_ < this.m_resMap.m_GrideDivision * this.m_resMap.m_GrideDivision)
         {
            ...
            {
               _loc7_ = int(this.m_resMap.m_lCellInfoList[_loc2_].triIdxbuf[_loc3_]);
               _loc8_ = int(this.m_resMap.m_lTrisBuf[_loc7_].v0);
               _loc9_ = int(this.m_resMap.m_lTrisBuf[_loc7_].v1);
               _loc10_ = int(this.m_resMap.m_lTrisBuf[_loc7_].v2);
