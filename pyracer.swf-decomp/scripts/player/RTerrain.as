package player
{
   ...
   public class RTerrain extends TriangleMesh3D
   {
      ...
      public function GetTerrainType(param1:Number, param2:Number) : Number
      {
         ...
         if((_loc5_ = int(this.m_heightMap.m_lHeightInfo[_loc5_])) < 0 || _loc5_ >= this.m_heightMap.m_lFaceInfo.length)
         {
            return -1;
         }
      ...
      public function GetHeightInfo(param1:Number, param2:Number) : Number
      {
         ...
         _loc6_ = Number(this.m_heightMap.m_lFaceInfo[_loc5_].A);
         _loc7_ = Number(this.m_heightMap.m_lFaceInfo[_loc5_].B);
         _loc8_ = Number(this.m_heightMap.m_lFaceInfo[_loc5_].C);
         _loc9_ = Number(this.m_heightMap.m_lFaceInfo[_loc5_].D);
         return -(_loc6_ * param1 + _loc8_ * param2 + _loc9_) / _loc7_;
      }
      ...
      public function GetTerrainInfo(param1:Number, param2:Number) : Object
      {
         ...
         _loc5_ = this.m_Split * _loc4_ + _loc3_;
         var _loc7_:Number = 1;
         _loc5_ = int(this.m_heightMap.m_lHeightInfo[_loc5_]);
         if(!(_loc3_ >= this.m_Split || _loc4_ >= this.m_Split))
         {
