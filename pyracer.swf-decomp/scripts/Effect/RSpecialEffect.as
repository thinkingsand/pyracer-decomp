package Effect
{
   ...
   public class RSpecialEffect extends MovieClip
   {
      ...
      private var m_EffectData:Effect.REffectData;
      
      public var m_ParticleManager:Effect.GameParticles;
      ...
      public function RSpecialEffect()
      {
         ...
         this.m_EffectData = new Effect.REffectData(0,null,null);
         super();
         this.m_ParticleManager = new Effect.GameParticles();
      ...
      public function EffectProcess(param1:Effect.REffectData) : void
      {
