      ...
      protected function ViewInfoFunc() : void
      {
         ...
         else
         {
            ...
            while(_loc5_ < _loc3_.length)
            {
               ...
               {
                  case 1:
                     _loc7_ = String(_loc4_.level1time);
                     break;
                  case 2:
                     _loc7_ = String(_loc4_.level2time);
                     break;
                  case 3:
                     _loc7_ = String(_loc4_.level3time);
                     break;
                  case 4:
                     _loc7_ = String(_loc4_.level4time);
                     break;
                  case 5:
                     _loc7_ = String(_loc4_.level5time);
                     break;
               }
               if(_loc7_ != "")
               {
